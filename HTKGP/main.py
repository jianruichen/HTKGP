...
parser.add_argument('-model', help='Model', type=str, default='HTKGP')
parser.add_argument('-ne', help='Number of epochs', type=int, default=500, choices = [500])
parser.add_argument('-bsize', help='Batch size', type=int, default=256, choices = [512])
parser.add_argument('-lr', help='Learning rate', type=float, default=0.003, choices = [0.001])
...
# parser.add_argument('-edropout', help='Dropout probability', type=float, default=0.1, choices = [0.0, 0.2, 0.4])
# parser.add_argument('-rdropout', help='Dropout probability', type=float, default=0.1, choices = [0.0, 0.2, 0.4])
# parser.add_argument('-tdropout', help='Dropout probability', type=float, default=0.1, choices = [0.0, 0.2, 0.4])
parser.add_argument('-save_each', help='Save model and validate each K epochs', type=int, default=20, choices = [20])
parser.add_argument('-se_prop', help='Static embedding proportion', type=float, default=0.5)
parser.add_argument('-mainfolds', type=str, default='PoincareBall')
